...
<body>
  ...
  <!-- PAGE 2: ARCHITECTURE & SYSTEM SCHEMATIC -->
  <div class="paper-page">
    ...
    <div class="figure-container">
      <img src="{fig1_b64}" alt="Figure 1: DWMA Architecture">
  ...
  <!-- PAGE 3: ALGORITHM 1 & CROSS-WORLD ADAPTATION -->
  <div class="paper-page">
...
7. Recursive Online Parameter Updates:
    ...
    <div class="figure-container">
      <img src="{fig2_b64}" alt="Figure 2: Phase 2 Adaptation">
      <div class="figure-caption">Figure 2: Representative single-seed empirical error trajectory in World B (Seed 1) showing instantaneous entry shock at t=1 (E(0) = 1.8491), autonomous polarity inversion at step 7.0, and error collapse (T_&epsilon; = 16.32 &plusmn; 0.62 steps).</div>
    </div>
  </div>

  <!-- PAGE 4: CONTINUAL RETENTION & HYPOTHESIS TESTING -->
  <div class="paper-page">
    ...
    <div class="figure-container">
      <img src="{fig3_b64}" alt="Figure 3: Phase 3 Retention">
  ...
  <!-- PAGE 5: CONSOLIDATED MASTER MATRIX -->
  <div class="paper-page">
    <h2>6. Consolidated Master Empirical Evaluation Matrix</h2>
    <p>Table 1 presents the complete performance profile across all 7 frozen baseline benchmarks and the 3 live empirical stress-tests. All values represent mean &plusmn; sample standard deviation across N = 50 deterministic seeds, alongside both parametric and non-parametric bootstrap 95% confidence intervals (B = 10,000 resamples).</p>
  ...
  <div class="paper-page">
    ...
    <h2>References</h2>
    <div style="font-size: 8.2pt; color: #475569; margin-bottom: 4px; font-style: italic;">35 foundational and contemporary references spanning world models, active inference, predictive coding, symbol grounding, and continual learning.</div>
    <ol class="references">
