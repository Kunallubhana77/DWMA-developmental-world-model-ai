...
|---|---|---|---|---|---|
| **DWMA Epistemic Policy** | Proxy Log-Ratio $\ln(B_{21})$ | **30.35 ± 8.03** | **31.74** | [28.07, 32.56] | **50/50 seeds (100.0%) [PASS]** |
| **Random Babbler Baseline** | Proxy Log-Ratio $\ln(B_{21})$ | **24.40 ± 18.52** | **19.26** | [19.64, 29.68] | **39/50 seeds (78.0%)** |
