...
| **A → B (Zero-Shot Novel B)** | Mean Shock Error $E(t)$ | 1.3079 ± 0.0421 | [1.2963, 1.3196] | [1.2965, 1.3198] | Zero-Shot Transfer Barrier |
| **A → C (Zero-Shot Radical C)** | Mean Shock Error $E(t)$ | 0.8117 ± 0.0272 | [0.8042, 0.8192] | [0.8041, 0.8193] | Zero-Shot Transfer Barrier |
| **A → B → B' (Adaptation)** | Initial Shock $E(0)$ | 1.8491 ± 0.3356 | [1.7561, 1.9422] | [1.7563, 1.9418] | Pre-adaptation shock ($t=1$) |
| **A → B → B' (Adaptation)** | Polarity Flip Latency | 7.00 ± 0.00 steps | [7.00, 7.00] | [7.00, 7.00] | Evidence $\Lambda_t < -0.50$ |
| **A → B → B' (Adaptation)** | Latency $T_\epsilon$ ($E < 0.20$) | 16.32 ± 0.62 steps | [16.15, 16.49] | [16.16, 16.50] | **50/50 seeds (100.0%)** |
